      ...
      <div id="layoutSidenav_content">
        ...
        <div class="form-card">
          <div class="form-header">
            ...
            <h1 class="form-title">Add Announcement</h1>
            <p class="form-subtitle">Share important announcements with residents</p>
          </div>
          <div class="form-body">
            <form id="add-announce-form" action="includes/add-announce.inc.php" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-floating">
                <div class="file-upload-area" onclick="document.getElementById('image').click()">
                  ...
                  <p style="margin: 0; color: #667eea; font-weight: 600;">Click to upload image</p>
                  <small style="color: #6c757d;">JPG, PNG files only (optional)</small>
                </div>
                <input type="file" id="image" name="image" accept="image/*" style="display: none;" />
              </div>
              <div class="text-center" style="margin-top: 2rem;">
                <button type="submit" name="add-announce" class="btn btn-submit text-white">
