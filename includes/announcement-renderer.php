...
function renderAnnouncementHero($totalAnnouncements) {
?>
    <!-- Hero Section -->
...
function renderAnnouncementCard($announcement, $userObj) {
...
?>
    ...
    <div class="announcement-card-modern" data-announcement-id="<?php echo $announcement['announcement_id']; ?>">
        <?php renderCardHeader($announcement); ?>
        <?php renderCardContent($announcement); ?>
        <?php renderCardInteractions($announcement, $countLikes, $allComments); ?>
        <?php renderCommentsSection($announcement, $allComments); ?>
    </div>
<?php
}

function renderCardHeader($announcement) {
?>
    <!-- Card Header -->
...
function renderCardContent($announcement) {
?>
    <!-- Card Content -->
...
function renderCardInteractions($announcement, $countLikes, $allComments) {
?>
    <!-- Card Interactions -->
...
function renderCommentsSection($announcement, $allComments) {
?>
    <!-- Comments Section -->
